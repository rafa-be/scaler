...
echo ""
echo "The Launchpad Try-it tab still defaults to installing opengris-scaler from PyPI even with"
echo "these wheels staged. To make it use this local build instead:"
echo "  LAUNCHPAD_TRYIT_LOCAL_WHEELS=1 make -C docs html"